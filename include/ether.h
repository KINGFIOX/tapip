...
static inline void hwacpy(void *dst, void *src) { memcpy(dst, src, ETH_ALEN); }

static inline void hwaset(void *dst, int val) { memset(dst, val, ETH_ALEN); }

static inline int hwacmp(void *hwa1, void *hwa2) { return memcmp(hwa1, hwa2, ETH_ALEN); }
...
static inline int is_eth_multicast(unsigned char *hwa) { return (hwa[0] & 0x01); }
