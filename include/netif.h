...
static _inline unsigned short _htons(unsigned short host) { return (host >> 8) | ((host << 8) & 0xff00); }
...
extern void _netdev_tx(struct netdev *nd, struct pkbuf *pkb, int len, unsigned short proto, unsigned char *dst);
...
extern void netdev_tx(struct netdev *nd, struct pkbuf *pkb, int len, unsigned short proto, unsigned char *dst);
#endif
